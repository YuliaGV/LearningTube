...
<!-- Site wrapper -->
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Bienvenido/a a LearningTube, tu plataforma de aprendizaje</h1>
            </div>
            </div>
        </div><!-- /.container-fluid -->
        </section>
        ...
        <div class="container-fluid">
            ...
            ?>
                ...
                <div class="col-md-3">
                    ...
                    <li><h4><?php echo $video['video_title']; ?></h4></li>
                    <li><p>Categoría: <?php echo $video['cat_name']; ?></p></li>
                    <li><p>Autor: <?php echo $video['user_name']; ?></p></li>
                    <li><span class="date">Publicado: <?php echo $video['video_date']; ?></span></li>
                    ...
                    <span class="pull-right text-muted">0 likes</span><br><br>
                    </li>
            ...
            echo "Todavía no has subido ningún video";
            }
            ?>
